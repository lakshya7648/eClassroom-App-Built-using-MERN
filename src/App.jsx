    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/teacher/login"
            element={<TeacherLogin setProgress={setProgress} setAlert={setAlert} />} />
          <Route
            path="/teacher/dashboard"
            element={<ProtectedRoute Component={TeacherHome} type={"teacher"} />}>
            <Route
              path="/teacher/dashboard" loader={<CircleSpinner />}
